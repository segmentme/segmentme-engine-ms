...
class StatisticServiceTest extends AccessServiceMock {
    ...
    @Override
    def setup() {
        participantsStatisticRepository.deleteAll();
        contextStatisticsRepository.deleteAll()
    }
    ...
    private ParticipantStatistic createParticipantStatistic(boolean segResult) {
        ...
        participantStatistic.setLastSegmentStatistic([new StatisticLog.SegmentStatistic(segmentId: SEGMENT_ID, analysisResult: segResult)]);
