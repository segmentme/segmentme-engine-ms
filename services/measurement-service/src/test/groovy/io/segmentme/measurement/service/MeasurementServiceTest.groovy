...
import io.segmentme.measurement.service.dto.ParticipantAcknowledgeRequest
import io.segmentme.measurement.service.dto.analysis.CollectedAnalysysStatisticDto
import io.segmentme.measurement.service.dto.analysis.CollectedAnalysysStatisticDto.ContextDataHolder
...
import io.segmentme.measurement.service.repository.ParticipantsStatisticRepository
import io.segmentme.measurement.service.repository.StatisticRepository
import io.segmentme.measurement.service.service.MeasurementService
import io.segmentme.measurement.service.service.ParticipantStatisticService
...
import io.segmentme.measurement.service.test.configuration.TestData
import io.segmentme.measurement.service.test.configuration.TestUser
...
//                    lastParticipantAnalyse.put(testData.getUser().getId(), collectedAnalysysStatisticDto)
    ...
    private CollectedAnalysysStatisticDto generateAnalysisStatisticEntry(TestData testData) {
        ...
        ContextDataHolder contextDataHolder = new ContextDataHolder()
