...
import io.segmentme.access.service.dto.analysis.CollectedAnalysysStatisticDto
import io.segmentme.access.service.dto.analysis.SegmentAnalysisResult
...
import io.segmentme.access.service.service.MeasurementService
import io.segmentme.access.service.service.ParticipantStatisticService
import io.segmentme.access.service.service.StatisticManager
...
class MeasurementServiceTest extends AccessServiceMock {
    ...
    @Autowired
    private io.segmentme.access.service.repository.StatisticRepository repository
    @Autowired
    ...
    def "RefreshParticipants"() {
        ...
        io.segmentme.access.service.test.configuration.TestData testData = null
...
//                    lastParticipantAnalyse.put(testData.getUser().getId(), collectedAnalysysStatisticDto)
    ...
    private io.segmentme.access.service.dto.ParticipantAcknowledgeRequest generateParticipantAcknowledge(io.segmentme.access.service.test.configuration.TestData testData) {
        io.segmentme.access.service.dto.ParticipantAcknowledgeRequest participantAcknowledgeRequest = new io.segmentme.access.service.dto.ParticipantAcknowledgeRequest()
    ...
    private CollectedAnalysysStatisticDto generateAnalysisStatisticEntry(io.segmentme.access.service.test.configuration.TestData testData) {
    ...
    public io.segmentme.access.service.test.configuration.TestData createTestData() {
        def testUser = new io.segmentme.access.service.test.configuration.TestUser()
        testUser.id = UUID.randomUUID().toString()
        testUser.email = UUID.randomUUID().toString()

        def data = new io.segmentme.access.service.test.configuration.TestData()
        data.user = testUser
        return data
    }
